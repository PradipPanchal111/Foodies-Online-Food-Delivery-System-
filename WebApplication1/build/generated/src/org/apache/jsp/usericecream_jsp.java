...
public final class usericecream_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("      <form action=\"home.jsp\"><button >Cart </button></form>\n");
   ...
   try
     {
       ...
       ResultSet rs=st.executeQuery("select * from TRADFOOD where type='icecream'");
       while(rs.next())
       {
     cnt++;
         out.print("<tc><td class='one'>"+"<h3 style='color:lemonchiffon'>"+rs.getString(1) +"</h3>"+
                 "<br><a href=bill.jsp?><img height=300 width=320  src=' "+rs.getString(4)+" ' /></a>"+"<br>"+
