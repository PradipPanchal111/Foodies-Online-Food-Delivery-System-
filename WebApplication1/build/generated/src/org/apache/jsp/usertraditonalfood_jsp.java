...
public final class usertraditonalfood_jsp extends org.apache.jasper.runtime.HttpJspBase
   ...
   try
     {
       ...
       ResultSet rs=st.executeQuery("select * from products where type='traditional'");
       while(rs.next())
       {
     cnt++;
