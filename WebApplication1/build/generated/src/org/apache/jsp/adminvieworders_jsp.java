...
public final class adminvieworders_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("      <!-- Buttons -->\n");
      out.write("    \n");
      out.write("    <form action=\"adminHome.jsp\"><button>Home</button></form>\n");
...
session.setAttribute("email",s);
      ...
      out.write("\n");
      out.write("   <table style=\"align-content: center;border-spacing: 80px\">\n");
      out.write("  ");
 ...
 out.print("<tr style='color:DodgerBlue'><th>Order Id</th><th>Product Name</th><th>Product Price</th><th>Product Quantity</th><th>Custmer Name</th><th>Custmer Email</th><th>Total Bill</th><th>Status</th></tr>");
       while(rs.next())
       {
        ...
        out.print("<tr'><td>"+rs.getString(1)+"</td><td><u>"+rs.getString(2)+"</u></td><td>"+rs.getString(3)+"</td><td><u>"+rs.getString(4)+"</u></td><td>"+rs.getString(5)+"</td><td style='color:blue'><u>"+rs.getString(6)+"</u></td><td style='color:yellow'>"+rs.getString(7)+"</td><td><form action='delivered.jsp'><input type='submit' value='"+rs.getString(8)+"'></td></tr>");
