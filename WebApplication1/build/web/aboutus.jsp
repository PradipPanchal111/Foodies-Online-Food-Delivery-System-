...
<body>
    ...
    <div style="color: deeppink; font-size: 40px;text-align: center;margin-top: 40px;">About Foodies</div>
    <div style="color: skyblue; font-size: 15px;text-align: center;">
      Name: The Foodies<br>
      Email :Foodies.com<br>
      contact:452145235
    </div>
