...
public final class adminAddProdDB_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    PreparedStatement ps=con.prepareStatement("insert into TRADFOOD values(?,?,?,?,?)");
       ps.setString(1, s1);
       ps.setString(2,s4 );
          ps.setString(3, s2);
      ps.setString(5,s5);
