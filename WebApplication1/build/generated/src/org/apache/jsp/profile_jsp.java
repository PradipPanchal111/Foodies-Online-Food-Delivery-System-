...
public final class profile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("      <!-- Buttons -->\n");
      out.write("    \n");
      out.write("      <form action=\"userLogin.jsp\"><button>Logout</button></form>\n");
      ...
      ResultSet rs=st.executeQuery("select * from products where name='"+s1+"'");
       out.print("<th>Name</th><td>"+rs.getString(1)+"<td><tr>");
       con.close();
       }
       catch(Exception e)
       {
